...
window.boot = function() {
	...
	function setLoadingDisplay() {
		...
		var arr=["ps：喵咪外表高冷，内心也是需要多多陪伴的哟~","ps：多多喂养、陪伴猫咪，还有金币奖励哦~","ps： 长期冷落你的猫咪，体力值和心情值都会大大下降的","ps：邀请你的朋友一起养猫咪，可以交流一下心得哟~"];
		...
		progressMsg.innerHTML=arr[~~(Math.random()*arr.length)];
